...
### Вкладка "Сервер":
![alt tag](/readme/config-server.png)
...
![alt tag](/readme/config-services.png)
...
### Вкладка "Статусы":
![alt tag](/readme/config-status.png)
...
![alt tag](/readme/config-common.png)
...
![alt tag](/readme/popups-mini.png)
